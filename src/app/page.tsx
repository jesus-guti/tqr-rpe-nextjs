...
export default function PlayerInterface() {
  ...
  const playerName = "Carlos"; // En una app real, esto vendría de la URL o autenticación
  ...
  const handlePreTrainingSave = () => {
    console.log("Pre-entrenamiento guardado:", {
      date: selectedDate,
      recovery: recovery[0],
      energy,
      soreness,
    });
    alert("Pre-entrenamiento guardado correctamente");
  };

  const handlePostTrainingSave = () => {
    console.log("Post-entrenamiento guardado:", {
      date: selectedDate,
      effort: effort[0],
    });
    alert("Post-entrenamiento guardado correctamente");
  };
